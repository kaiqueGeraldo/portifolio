...
export interface Project {
  ...
  duracao: string;
  status: "Finalizado" | "Em Desenvolvimento" | "Pausado";
}
...
export const projetos: Project[] = [
  ...
  },
  {
    ...
    imagem: Assets.Projects.CampusSync,
    link: "https://github.com/kaiqueGeraldo/campus_sync.git",
    tecnologias: [
      {
        nome: ["C#", ".NET Framework", ".NET Core", "SQL Server"],
        icone: [ Assets.Skills.CSharp, Assets.Skills.Net, Assets.Skills.Net, Assets.Skills.SQL ],
